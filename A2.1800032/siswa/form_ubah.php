...
if (isset($_GET['nis'])) {
    $nis = $_GET['nis'];
    $query = mysqli_query($db, "SELECT * FROM tbl_siswa WHERE nis='$nis'") or die
    ('query erorr: '.mysqli_error($db));
   ...
   <form class="needs-validation" action="proses_ubah.php" method="post" enctype="multipart/form-data" novalidate>
    <div class="row">
     <div class="col">
      ...
      <div class="form-group col-md-12">
       ...
       <div class="custom-control custem-radio">
      ...
      <div class="custom-control custem-radio mb-4">
    ...
    <div class="col">
      ...
      <div class="form-group col-md-12">
       ...
       autocomplete="off" required><?php echo $alamat; ?></textarea>
    ...
    <div class="col">
      <div class="form-group col-md-12">
       ...
       <input type="file" class="form-control-file mb-3" id="foto" 
       name="foto" onchange="return validasiFile()"  autocomplete="off"
       value="<?php echo $foto; ?>">
