...
if (isset($_GET['nis'])) {
    ...
    $query = mysqli_query($db, "SELECT * FROM tbl_siswa WHERE nis='$nis'") or die(mysqli_error($db));
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" action="proses_ubah.php" method="post" enctype="multipart/form-data"
                    novalidate>
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" id="customControlValidation2"
                                        ...
                                        <?=$jenis_kelamin == 'Laki-laki' ? 'checked' : ''; ?> required>
                                ...
                                <div class="custom-control custom-radio mb-4">
                                    <input type="radio" class="custom-control-input" id="customControlValidation3"
                                        ...
                                        <?=$jenis_kelamin == 'Perempuan' ? 'checked' : ''; ?> required>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy"
                                    name="tanggal_lahir" autocomplete="off" value="<?=$tanggal_lahir; ?>" required>
                                <div class="invalid-feedback">Tanggal Lahir tidak boleh kosong.</div>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Alamat</label>
                                <textarea class="form-control" rows="2" name="alamat" autocomplete="off"
                        ...
                        <div class="col">
                            <div class="form-group col-md-12">
                                ...
                                <input type="file" class="form-control-file mb-3" id="foto" name="foto"
                                    onchange="return validasiFile()" autocomplete="off" value="<?=$foto; ?>">
                                <div id="imagePreview">
                                    <img class="foto-preview" src="foto/<?=$foto; ?>" width="250">
                                </div>
                            </div>
                        </div>
                    </div>
