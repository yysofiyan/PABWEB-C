                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group col-md-12">
                                ...
                                <input type="file" class="form-control-file mb-3" id="foto" name="foto" onchange="validasiFile()" autocomplete="off" required>
                                <div id="imagePreview">
                                    <img class="foto-preview" src="assets/img/Gull_portrait_ca_usa.jpg" />
                                </div>
